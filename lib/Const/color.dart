...
const Color primary = Color(0xff1a2c38);
const Color splashBg = Color(0xff616161);
const Color red = Color(0xfff10027);
const Color grey = Color(0xff6c7072);
const Color buttoncolor = Color(0xff23adde);
const Color chatboxcolor = Color(0xffe5e5e5);

const Color secondary = Color(0xff274051);
const Color textColor = Color(0xff394150);
